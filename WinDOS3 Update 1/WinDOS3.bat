...
mode 600
title WinDOS3
cd "D:\LTD\Windows Batch Project\WinDOS3\SYS"
start UPDATE.bat
...
timeout 2 > NUL
echo Checking files...
If exist "D:\LTD\Windows Batch Project\WinDOS3\SYS\BOOT.ini" (
    msg * Files existed...
) 
if NOT exist "D:\LTD\Windows Batch Project\WinDOS3\SYS\BOOT.ini" (
   cd "D:\Le Trieu Duong\Programming\WinDOS3\SYS"
   start errscr.bat
   exit  
)
timeout 2 > NUL
